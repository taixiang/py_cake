...
friend = '467220125' # 朋友的QQ号，**朋友的空间要求允许你能访问**，这里可以输入自己的qq号
user = '467220125'  # 你的QQ号
pw = '&*dota0523tx'  # 你的QQ密码
...
while True:
    ...
    selector = BeautifulSoup(driver.page_source, "html5lib")

    content = selector.find("div", class_="feed_wrap").ol

    divs = content.find_all("li",class_="feed")
    ...
    with open('qq_word.txt', 'a', encoding='utf-8') as f:
        for div in divs:
            ...
            qq_name = div.find("div", class_="bd")
            print(type(qq_name))
            print(div)
            print("\n\n")
            # print(qq_name.a)
            # print(qq_name.contents[0].a)
